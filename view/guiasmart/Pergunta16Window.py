...
class Pergunta16Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            # main
            h_layout = QHBoxLayout()
            pergunta = QLabel('Quanto tempo médio sua empresa gasta para concluir a produção de um item ou de uma ordem de serviço?')
            ...
            radio1 = QRadioButton("Até 60 min")
            radio2 = QRadioButton("Entre 61 e 240 min")
            radio3 = QRadioButton("Entre 241 e 480 min")
            radio4 = QRadioButton("Mais de um dia")
            radio5 = QRadioButton("Mais de 30 dias")
            radio6 = QRadioButton("Mais de 90 dias")
    ...
    def responder(self, index):
        ...
        if texto == "Não sei responder":
            ...
            resposta = self.radio_group.id(checked_button)+83
