...
class Pergunta4Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            # main
            h_layout = QHBoxLayout()
            pergunta = QLabel('Quanto à quantidade de controle de processos e de informações, como você classifica seu ambiente?')
            ...
            radio1 = QRadioButton("Baixa quantidade")
            radio2 = QRadioButton("Moderada")
            radio3 = QRadioButton("Alta quantidade")
