...
class Pergunta6Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            # main
            h_layout = QHBoxLayout()
            pergunta = QLabel('As máquinas e/ou equipamentos da sua linha de produção são independentes? Ou seja, o fluxo é irregular, passando por diferentes máquinas em diferentes sequências de operações?')
            ...
            radio1 = QRadioButton("SIM")
            radio2 = QRadioButton("NÃO")
