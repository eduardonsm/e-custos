...
class Pergunta27Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            # main
            h_layout = QHBoxLayout()
            pergunta = QLabel('O que seria mais importante como objeto de custeio para a sua empresa?')
            ...
            radio1 = QRadioButton("Custear produtos [custo por unidade]")
            radio2 = QRadioButton("Custear ordens de produção, montagem, etc.")
            radio3 = QRadioButton("Custear setores produtivos [departamentos]")
            radio4 = QRadioButton("Custear pedidos específicos de clientes")
            radio5 = QRadioButton("Custear processos ou atividades")
            radio6 = QRadioButton("Custear a força de transformação na produção ")
            radio7 = QRadioButton("Outro")
            radio8 = QRadioButton("Não sei responder")            
    ...
    def responder(self, index):
        ...
        if texto == "Não sei responder" or texto == "Outro":
            resposta = None
        else:
            resposta = self.radio_group.id(checked_button)+144
