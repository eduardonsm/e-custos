...
class Pergunta21Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            # main
            h_layout = QHBoxLayout()
            pergunta = QLabel('Em qual(is) das dimensões competitivas seus principais produtos concorrem? Mais de uma opção pode ser escolhida')
            ...
            radio1 = QRadioButton("Preço/Custo/Margem de contribuição")
            radio2 = QRadioButton("Qualidade e diferenciação de produto")
            radio3 = QRadioButton("Disponibilidade do produto")
            radio4 = QRadioButton("Rapidez no processo e lead-time curto")
            radio5 = QRadioButton("Confiabilidade nas operações")
            radio6 = QRadioButton("Responsividade na demanda")
            radio7 = QRadioButton("Produtividade e eficiência dos recursos")
            radio8 = QRadioButton("Sustentabilidade ambiental")
            radio9 = QRadioButton("Flexibilidade dos recursos e do mix")
    ...
    def responder(self, index):
        ...
        if texto == "Não sei responder":
            ...
            resposta = self.radio_group.id(checked_button)+105
