...
class Pergunta17Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            titulo = QLabel("PROCESSOS PRODUTIVOS")
            ...
            self.min_label = QLabel("Segundos")
            self.max_label = QLabel("Meses")
            ...
            radio4 = QRadioButton("")
            radio5 = QRadioButton("")
            style = "QRadioButton { max-width: 10px; }"
            for radio in [radio1, radio2, radio3, radio4, radio5]:
                radio.setStyleSheet(style)

            buttons_container.addWidget(self.min_label, alignment=Qt.AlignmentFlag.AlignCenter)
            buttons_container.addWidget(radio1, alignment=Qt.AlignmentFlag.AlignCenter)
            buttons_container.addWidget(radio2, alignment=Qt.AlignmentFlag.AlignCenter)
            buttons_container.addWidget(radio3, alignment=Qt.AlignmentFlag.AlignCenter)
            buttons_container.addWidget(radio4, alignment=Qt.AlignmentFlag.AlignCenter)
            buttons_container.addWidget(radio5, alignment=Qt.AlignmentFlag.AlignCenter)
            buttons_container.addWidget(self.max_label, alignment=Qt.AlignmentFlag.AlignCenter)

            v_layout.addLayout(buttons_container)    
                
            #radio buttons
            radio6 = QRadioButton("Não sei responder")
            radio6.setMaximumWidth(300)
            ...
            v_layout.addWidget(radio6, alignment=Qt.AlignmentFlag.AlignCenter)
    ...
    def responder(self, index):
        ...
        if texto == "Não sei responder":
            ...
            resposta = self.radio_group.id(checked_button)+89
