...
class Pergunta20Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            # main
            h_layout = QHBoxLayout()
            pergunta = QLabel('Como é baseada a demanda de materiais, componentes ou matérias-primas no setor de almoxarifado?')
            ...
            radio1 = QRadioButton("Pelo que será consumido das ordens de produção")
            radio2 = QRadioButton("Pelo que será orçado no período como gasto")
            radio3 = QRadioButton("Sob demanda específica, sempre que necessário")
    ...
    def responder(self, index):
        ...
        if texto == "Não sei responder":
            ...
            resposta = self.radio_group.id(checked_button)+102
