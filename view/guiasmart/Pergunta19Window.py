...
class Pergunta19Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            # main
            h_layout = QHBoxLayout()
            pergunta = QLabel('Qual seria o prazo prometido de entrega dos produtos para um raio de até	 500 km nos dias úteis?')
            ...
            radio1 = QRadioButton("Até uma hora")
            radio2 = QRadioButton("Entre 1 e 8 horas")
            radio3 = QRadioButton("Entre 1 dia e 5 dias")
            radio4 = QRadioButton("Entre 1 semana e 1 mês")
            radio5 = QRadioButton("Mais de 1 mês")
            ...
            for radio in [radio1, radio2, radio3, radio4, radio5, radio6]:
    ...
    def responder(self, index):
        ...
        if texto == "Não sei responder":
            ...
            resposta = self.radio_group.id(checked_button)+97
