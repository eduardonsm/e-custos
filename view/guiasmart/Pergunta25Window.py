...
class Pergunta25Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            # main
            h_layout = QHBoxLayout()
            pergunta = QLabel('Com base no que você respondeu, o que você gostaria de considerar no custeio para fins de tomada de decisão?')
            ...
            radio1 = QRadioButton("Custos fixos e variáveis")
            radio2 = QRadioButton("Apenas os custos variáveis")
            radio3 = QRadioButton("Custos fixos e variáveis, exceto os relativos aos desperdícios")
    ...
    def responder(self, index):
        ...
        if texto == "Não sei responder":
            ...
            resposta = self.radio_group.id(checked_button)+132
