...
class Pergunta23Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            pergunta = QLabel('De 0 a 100%, o quão você estima a dominância dos seus custos, quanto à variabilidade? À esquerda, são dominantes em custos variáveis (100%), no centro, são divididos (50%) e à direita, são dominantes em custos fixos (100%). ')
            ...
            self.min_label = QLabel("100% Custos variáveis")
            self.max_label = QLabel("100% Custos fixos")
