...
class Pergunta13Window(QWidget):
    ...
    def __init__(self, stacked_widget):
            ...
            # main
            h_layout = QHBoxLayout()
            pergunta = QLabel('Sobre as características do mix, carta ou famílias de produtos da sua empresa, como você classifica o perfil geral dos seus itens?')
            ...
            radio1 = QRadioButton("Produtos com elevado grau de padronização e pouca diferenciação")
            radio2 = QRadioButton("Produtos com elevado valor agregado com alguma personalização")
            radio3 = QRadioButton("Não sei responder")
    ...
    def responder(self, index):
        ...
        if texto == "Não sei responder":
            ...
            resposta = self.radio_group.id(checked_button)+70
